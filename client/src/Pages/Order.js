...
import order from "../assets/pentol.png"
          ...
          <Col>
            {cartData?.length === 0 ? (
              <Col className="d-flex flex-column justify-content-center align-items-center">
                ...
                <h1>Oooops!!</h1>
                <h1>where your order? :( </h1>
                <h1>order now dong bestiiii </h1>
              </Col>
            ) : (
              cartData?.map((item) => (
                <Col>
                    ...
                    <Col>
                      <Row className="d-flex align-items-center text-start">
                        ...
                        <Col className="col-9 ps-5 ps-lg-0">
                          <h6 className="my-3 fw-bold">{item.product.title}</h6>
                          <h6 className="my-3">
                            <Button
          ...
          >
            <Modal.Body>
              <div className="text-center">
                <h2 className="text-success">Orderan sedang diproses</h2>
                <img src={order} className="w-25" animation="grow"  alt=""/>
                <hr />
                {/* <h3>Total Harga</h3>
                <h2 className="text-danger">
                  {convertRupiah.convert(subTotal + 10000 * cartLength)}
                </h2> */}
                <h2 className="text-success">Makananmu akan segera tiba</h2>
